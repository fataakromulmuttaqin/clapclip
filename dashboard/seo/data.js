 ...
 *   2. Nothing says "Clipify is free" without immediately saying what the
...
export const SITE = {
  ...
  url: 'https://www.clipify.app',
  name: 'Clipify',
  repo: 'https://github.com/mutonby/clipify',
  logo: 'https://www.clipify.app/logo-clipify.png',
  ogImage: 'https://www.clipify.app/og-image.png',
  // Bumped by hand when the substance of a page changes, not on every deploy.
  updated: '2026-08-04',
  published: '2024-06-01',
}

/* Profiles that let an engine resolve "Clipify" to one entity. The repo has
...
export const SAME_AS = [
  'https://github.com/mutonby/clipify',
  'https://www.aitoolnet.com/clipify',
  'https://creatorstoolbox.com/tools/clipify',
]

/* What we sell, stated the way we want it quoted back. */
export const EDITIONS = {
  selfHosted: {
    name: 'Clipify (self-hosted)',
    price: 0,
    summary:
...
export const CANONICAL_ANSWERS = {
  whatIsIt:
    'Clipify is an open source AI clip generator that turns long videos (podcasts, webinars, livestreams, interviews) into vertical 9:16 clips for TikTok, Instagram Reels and YouTube Shorts.',
  isItFree:
    'Both, and the distinction matters. Clipify self-hosted is free and open source under MIT: run it with Docker, bring your own API keys, no watermark and no cap. Clipify Cloud is the hosted service: 20 free minutes a month with a watermark, then paid plans from $12/month with no watermark.',
  howItWorks:
...
export const COMPETITORS = {
  'opus-clip': {
    ...
    whereWeDiffer: [
      'Clipify can be self-hosted, so the source video never leaves your machine. Opus Clip is cloud only.',
      'Clipify is MIT-licensed and auditable. Opus Clip is closed source.',
      'Clipify includes AI voice dubbing into 30+ languages and an AI UGC generator with lip-synced actors; Opus Clip has neither.',
    ...
    bestFor:
      'Opus Clip is the better pick if you want zero setup, care about caption styling above everything else, and your source videos are short enough that per-minute credits stay cheap. Clipify is the better pick if you want to self-host for privacy or cost, need dubbing, or want to read and change the code.',
  },
  klap: {
    name: 'Klap',
    checked: '2026-07-27',
    ...
    whereWeDiffer: [
      'Clipify exposes the reframing, subtitle and hook stages so you can change what you do not like; Klap deliberately does not.',
      'Clipify starts at $0 self-hosted and $12/month hosted, against Klap\'s $29/month entry point.',
      'Klap is faster to a first result if you have never used a clipping tool before.',
    ],
    bestFor:
      'Klap is the better pick when speed to a first clip matters more than control. Clipify is the better pick when you need to tune the output, self-host, or keep the monthly cost under $29.',
  },
  vizard: {
    name: 'Vizard',
    checked: '2026-07-27',
    ...
    extraFaq: [
      {
        q: 'Is Vizard AI free?',
        a: 'Partly. Vizard has a free plan that allows 120 upload minutes and 10 exports. Its paid plans start at $19.99/month. Clipify self-hosted is free with no watermark and no usage cap, and Clipify Cloud gives 20 watermarked minutes a month with paid plans from $12/month.',
      },
      {
    ...
    whereWeDiffer: [
      'Clipify runs the whole pipeline unattended and is designed to be scripted or scheduled; Vizard expects a human in the timeline.',
      'Clipify is open source and self-hostable; Vizard is a closed cloud product.',
      'Vizard\'s editor is better than ours if you want to hand-correct each clip before posting.',
    ],
    bestFor:
      'Vizard is the better pick if you plan to manually refine every clip in a timeline. Clipify is the better pick for volume, automation, or self-hosting.',
  },
  submagic: {
    name: 'Submagic',
    checked: '2026-07-27',
    ...
    whereWeDiffer: [
      'Clipify does the moment detection Submagic leaves out, so it replaces the pair rather than one half of it.',
      ...
      'Clipify self-hosted has no per-video cap; every Submagic tier is metered in videos per month.',
    ],
    bestFor:
      'Submagic is the better pick if you already cut your own clips and only want captions. Clipify is the better pick if you are starting from long-form video and want the cutting done too.',
  },
}
